"""
Fine-tune SpeechT5 model on NonverbalTTS dataset.
SpeechT5 is a versatile TTS model from Microsoft that's easier to fine-tune than XTTS.
"""
import os
import json
import torch
...
def main():
    ...
    output_dir = Path("checkpoints/speecht5_finetuned")
    ...
    print("=" * 70)
    print("Fine-tuning SpeechT5 on NonverbalTTS Dataset")
    print("=" * 70)
    print(f"\nDevice: {device}")
